	...
	int Jacobi_precond_EBE (ParametersType *, MatrixDataType *, FemStructsType *,double *, double *);
	int Jacobi_precond_EDE (ParametersType *, MatrixDataType *, FemStructsType *,double *, double *);
	...
	int Jacobi_precond_EBE_setup (ParametersType *, MatrixDataType *, FemStructsType *, int, double *);
	int Jacobi_precond_EDE_setup (ParametersType *, MatrixDataType *, FemStructsType *, int, double *);
