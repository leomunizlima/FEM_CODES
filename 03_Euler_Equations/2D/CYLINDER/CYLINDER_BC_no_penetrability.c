				    ...
				    double R1[12], double R2[4], double Ue[12], double dUe[12], double UeB[4], double dUeB[4])
{
	...
	if ((Node[J1].v1Type == -1 || Node[J1].v2Type == -1)&&(fabs(Node[J1].x)>1e-5)){
		tag = 1;
	...
	if ((Node[J2].v1Type == -1 || Node[J2].v2Type == -1)&&(fabs(Node[J2].x)>1e-5)){
		tag = 1;
	...
	if ((Node[J3].v1Type == -1 || Node[J3].v2Type == -1)&&(fabs(Node[J3].x)>1e-5)){
		tag = 1;
