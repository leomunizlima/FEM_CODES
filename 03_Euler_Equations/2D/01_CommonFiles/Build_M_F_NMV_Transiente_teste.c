...
int Build_M_F_NMV_Transiente(ParametersType *Parameters, double *delta_old, double *delta_old_NMV, double delta_t, double alpha, int **lm, MatrixDataType *MatrixData, double *F, double *u, double *du,
