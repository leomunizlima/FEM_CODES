...
double Delta_CAU_NMV(double tolerance, double *delta_old, double *gradUx, double *gradUy, double (*Ax)[4], double (*Ay)[4], double (*A0)[4], 
...
//		aux_delta = 0.5*norma_LUh / norma_gradksiU;
		aux_delta = norma_LUh / norma_gradksiU;
//
	else
		aux_delta = 0.0;
